...
public class EmployeeService {
    ...
    public List<Employee> findByNameRu(String pattern) {
        ...
        return employeeRepository.findRu("^" + pattern,  PageRequest.of(0, 10));
    }

    public List<Employee> findByNameEn(String pattern) {
        log.info("Search by latin pattern, last name begins with '{}'", pattern);
        return employeeRepository.findEn("^" + pattern, PageRequest.of(0, 10));
    }

    public List<Employee> findByPhone(String hash) {
        return employeeRepository.findByPhone(hash);
    }
}
